...
public class score_fruit : MonoBehaviour
{
    ...
    void Start()
    {
        minute = PlayerPrefs.GetInt("minutepast_fruit");
        second = PlayerPrefs.GetInt("secondspast_fruit");
        wrong = PlayerPrefs.GetInt("Wrong_fruit");
