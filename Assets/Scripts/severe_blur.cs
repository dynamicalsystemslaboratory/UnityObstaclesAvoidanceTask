...
[ExecuteInEditMode]
//添加选项到菜单中
[AddComponentMenu("RapidBlur")]
public class severe_blur : MonoBehaviour
{
    //-------------------变量声明部分-------------------
    #region Variables

    //指定Shader名称
    private string ShaderName = "RapidBlur";
    ...
    public float BlurSpreadSize = 4.5f;
    //迭代次数
    [Range(0, 8), Tooltip("[迭代次数]此值越大,则模糊操作的迭代次数越多，模糊效果越好，但消耗越大。")]
    public float BlurIterations = 5.5f;
