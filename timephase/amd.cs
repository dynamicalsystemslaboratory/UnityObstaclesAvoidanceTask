...
public class amd: MonoBehaviour
{
	...
	void Update()
	{
		...
		{
			PlayerPrefs.SetInt("minuteamd", (int)minutes);
			PlayerPrefs.SetInt("secondsamd", (int)seconds);
			PlayerPrefs.SetInt("collisionamd", collide);
			SceneManager.LoadScene("Scoreboard_amd");
		}
