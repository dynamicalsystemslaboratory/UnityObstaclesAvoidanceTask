...
public class diabetic : MonoBehaviour
{
	int collide = 0;
	bool flag = false;
	bool flag2 = false;
	...
	void Update()
	{
		...
		{
			PlayerPrefs.SetInt("minutediabetic", (int)minutes);
			PlayerPrefs.SetInt("secondsdiabetic", (int)seconds);
			PlayerPrefs.SetInt("collisiondiabetic", collide);
			SceneManager.LoadScene("scoreboard_db");
		}
