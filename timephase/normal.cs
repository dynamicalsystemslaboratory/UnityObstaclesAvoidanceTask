...
public class normal : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
			PlayerPrefs.SetInt("minuteNormal", (int)minutes);
			PlayerPrefs.SetInt("secondsNormal", (int)seconds);
			PlayerPrefs.SetInt("collisionNormal", collide);
			SceneManager.LoadScene("Scoreboard_normal");
		}
